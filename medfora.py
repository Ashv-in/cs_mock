...
1. Profile creation for new patients
2. New prescriptions can be added by doctors
3. Lab reports get auto-updated
4. Easily share complete medical history
'''
...
#functions for new prescriptions and lab reportsz
